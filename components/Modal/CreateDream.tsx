                ...
                <form>
                    ...
                    <div className={styles.submit}>
                        ...
                        <div className={styles.links}>
                            <Link href="/"><Image src="/instagram.svg" alt="" width={25} height={25}/></Link>
                            <Link href="/"><Image src="/twitter.svg" alt="" width={25} height={25}/></Link>
                            <Link href="/"><Image src="/vk.svg" alt="" width={25} height={25}/></Link>
                        </div>
                    </div>
                </form>
